	...
	<div class="centerContent font-poppins">
		<NuxtLayout>
			<NuxtLoadingIndicator
				:height="5"
				color="repeating-linear-gradient(to right,#FEC400 0%,#E3F5FF 50%,#FEC400 100%)"
			/>
			<NuxtPage />
			<div
				class="fixed z-50 px-3 py-2 text-sm font-bold text-white bg-gray-900 rounded bottom-4 left-4"
			>
				...
				<span class="hidde n lg:inline-block xl:hidden">LG</span>
